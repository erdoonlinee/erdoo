...
cl = CYBERTK.LINE()
cl.login(token="ErDQZraizGNneHNilDU0.zUxHyMVNy7N4HgHSWhh/8a.bBYEjmvATZaTEYUjD2kTd5ikkc6Oh6cXdv6x0V3mqag=")
cl.loginResult()
...
Emreylcn LİNE
\n
Login śєʟғ =====[̈́͑̏͊EFENDİM̘ CANIM ͉̲]====
"""
reload(sys)
...
""",    
    "lang":"JP",
    "comment":"Thanks For Add ☆ Emre  ☆\n\n\Support By ~ ҳ̸Ҳ̸ҳ Emre тҝ ҳ̸Ҳ̸ҳ\n\n✯==== Creator ====✯\n\emre",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						cl.sendText(msg.to,"[güm | emreonlinee   в̴̡̛͈̖̺͖̙̝̩̞̐̂̀͂̏̚͟͠σ̊̑̾͘т║")
						#kk.sendText(msg.to,"..")
						targets = []
						for g in gs.members:
